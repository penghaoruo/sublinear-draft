...
Later, the work of Parallel Latent Dirichlet Allocation (PLDA)~\cite{wang2009plda} improves the computational efficiency of the LDA model by means of sampling methods.
